    ...
    <div class="flex min-h-screen">
        ...
        <div class="w-64 bg-white shadow-lg">
            ...
            <nav class="py-4">
                ...
                <a href="dashboard.php" class="flex items-center px-6 py-3 text-gray-700 bg-gray-100 border-l-4 border-blue-600">
                    <i class="fas fa-tachometer-alt w-5"></i>
                    <span class="mx-3">Dashboard</span>
                </a>
                
                <div class="px-4 py-2 mt-4 text-xs font-semibold text-gray-600 uppercase">Books Management</div>
                <a href="books.php" class="flex items-center px-6 py-3 text-gray-700 hover:bg-gray-100 hover:border-l-4 hover:border-blue-600">
                    <i class="fas fa-book w-5"></i>
                    <span class="mx-3">Books</span>
                </a>
                <a href="categories.php" class="flex items-center px-6 py-3 text-gray-700 hover:bg-gray-100 hover:border-l-4 hover:border-blue-600">
                    <i class="fas fa-tags w-5"></i>
                    <span class="mx-3">Categories</span>
                </a>
                <a href="authors.php" class="flex items-center px-6 py-3 text-gray-700 hover:bg-gray-100 hover:border-l-4 hover:border-blue-600">
                ...
                <a href="users.php" class="flex items-center px-6 py-3 text-gray-700 hover:bg-gray-100 hover:border-l-4 hover:border-blue-600">
                    <i class="fas fa-users w-5"></i>
                    <span class="mx-3">Users</span>
                </a>
                
                <div class="px-4 py-2 mt-4 text-xs font-semibold text-gray-600 uppercase">Settings</div>
                <a href="profile.php" class="flex items-center px-6 py-3 text-gray-700 hover:bg-gray-100 hover:border-l-4 hover:border-blue-600">
                    <i class="fas fa-user-circle w-5"></i>
                    <span class="mx-3">Profile</span>
                </a>
                <a href="settings.php" class="flex items-center px-6 py-3 text-gray-700 hover:bg-gray-100 hover:border-l-4 hover:border-blue-600">
